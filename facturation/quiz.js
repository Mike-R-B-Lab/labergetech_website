...
if (typeof document !== 'undefined') {
  ...
  const UI = {
    fr: {
      ...
      gainText: "On peut maintenant regarder 1 ou 2 de vos vraies factures pour confirmer ce qui peut être automatisé et ce qui doit rester sous contrôle humain.",
    ...
    en: {
      ...
      gainText: 'We can now look at 1 or 2 of your real invoices to confirm what can be automated and what should stay under human control.',
